(() => {
    ...
    var t = {
            ...
            865: function(t, e, n) {
                var i = this && this.__decorate || function(t, e, n, i) {
                        ...
                        if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) a = Reflect.decorate(t, e, n, i);
                            ...
                            for (var l = t.length - 1; l >= 0; l--)(o = t[l]) && (a = (r < 3 ? o(a) : r > 3 ? o(e, n, a) : o(e, n)) || a);
                ...
                class h {
                    ...
                    static tryFill(t) {
                        ...
                        return r(this, void 0, void 0, (function*() {
                            const r = yield v.Tracker.getTruthyLead(), a = h.classifyInput(t);
                            a === l.InputType.Phone && (t.value = null !== (e = r.phone) && void 0 !== e ? e : ""), a === l.InputType.Email && (t.value = null !== (n = r.email) && void 0 !== n ? n : ""), a === l.InputType.Name && (t.value = `${null!==(i=r.firstName)&&void 0!==i?i:""} ${null!==(o=r.lastName)&&void 0!==o?o:""}`)
                        }))
                    }
            ...
            774: function(t, e, n) {
                ...
                class d {
                    static init() {
                        this.inited || (this.inited = !0, d.monitorWindowOpen(), d.monitorLinks(!0), d.monitorButtons(!0), d.monitorForms(!0), new l.Observer({
                            throttle: 2e3,
                            groupEvents: !0
                        }).observeNewElements(document.body, (() => {
                    ...
                    static monitorButtons(t) {
                        ...
                        console.log("buttons", e), e.forEach((e => {
                            (t || this.canUseEl(e)) && e.addEventListener("click", (t => {
                                var n, i, o, r;
                                console.log("button clicked pixel", e), (d.isCheckoutButtonText(null !== (n = e.textContent) && void 0 !== n ? n : "") || d.isCheckoutButtonClassList(null !== (i = e.classList) && void 0 !== i ? i : "")) && (console.log("tracking ic with button", e), s.Tracker.track("InitiateCheckout")), d.isLeadButtonText(null !== (o = e.textContent) && void 0 !== o ? o : "") && (console.log("tracking lead with button", e), s.Tracker.track("Lead")), d.isAddToCartButtonText(null !== (r = e.textContent) && void 0 !== r ? r : "") && (console.log("tracking add to cart with button", e), s.Tracker.track("AddToCart"))
                            }), !0)
                        }))
                    }
                    static monitorForms(t) {
                        Array.from(document.querySelectorAll("form")).forEach((e => {
                            (t || this.canUseEl(e)) && e.addEventListener("submit", (t => {
                                ...
                                console.log("submitButton", a), d.isCheckoutButtonText(null !== (n = null == a ? void 0 : a.textContent) && void 0 !== n ? n : "") && (console.log("tracking ic with form", e), s.Tracker.track("InitiateCheckout")), d.isCheckoutButtonClassList(null !== (i = null == a ? void 0 : a.classList) && void 0 !== i ? i : null) && (console.log("tracking ic with form", e), s.Tracker.track("InitiateCheckout")), d.isCheckoutLink(e.action, void 0, void 0) && (console.log("tracking ic with form", e), s.Tracker.track("InitiateCheckout")), d.isLeadButtonText(null !== (o = null == a ? void 0 : a.textContent) && void 0 !== o ? o : "") && (console.log("tracking lead with button", a), s.Tracker.track("Lead")), d.isAddToCartButtonText(null !== (r = null == a ? void 0 : a.textContent) && void 0 !== r ? r : "") && (console.log("tracking add to cart with button", a), s.Tracker.track("AddToCart"))
                            }), !0)
                        }))
                    }
                    ...
                    static monitorLinks(t) {
                        Array.from(document.querySelectorAll("a")).forEach((e => {
                            (t || this.canUseEl(e)) && e.addEventListener("click", (t => {
                                ...
                                console.log("canSendIc", r), r && d.waitBeforeAction(t, s.Tracker.track("InitiateCheckout"), e);
                                const a = d.isLeadButtonText(null !== (i = e.textContent) && void 0 !== i ? i : "");
                                console.log("canSendLead", a), a && d.waitBeforeAction(t, s.Tracker.track("Lead"), e);
                                const l = d.isAddToCartButtonText(null !== (o = e.textContent) && void 0 !== o ? o : "");
                                console.log("canAddToCart", l), l && (console.log("tracking add to cart with button", e), d.waitBeforeAction(t, s.Tracker.track("AddToCart"), e))
                            }), !0)
                        }))
                    }
                    static waitBeforeAction(t, e, n) {
                        ...
                        return r(this, void 0, void 0, (function*() {
                            ...
                            l.flagged = !0, null === (o = t.target) || void 0 === o || o.dispatchEvent(l), console.log("dispatched event", l), n.onclick = r
                        }))
                    }
                    static canUseEl(t) {
                    ...
                    static isCheckoutLink(t, n, i) {
                        ...
                        if (l.icURLMatch) return null !== (o = null == t ? void 0 : t.includes(l.icURLMatch)) && void 0 !== o && o;
                        if (null != l.icTextMatch) {
                            if (null == n ? void 0 : n.includes(l.icTextMatch)) return !0;
                            const t = d.removeInvisibleCharsFromText(n);
                            return null !== (r = null == t ? void 0 : t.includes(l.icTextMatch)) && void 0 !== r && r
                        }
                        if (l.icCSSMatch) return null !== (a = null == i ? void 0 : i.contains(l.icCSSMatch)) && void 0 !== a && a;
                ...
                class u {
                    static init(t) {
                        return r(this, void 0, void 0, (function*() {
                            ...
                            }, e._fbq || (e._fbq = o), o.push = o, o.loaded = !0, o.version = "2.0", o.queue = [], (a = n.createElement(i)).async = !0, a.src = "https://connect.facebook.net/en_US/fbevents.js", null == (l = n.getElementsByTagName(i)[0]) || l.parentNode.insertBefore(a, l))), t && t.length > 0 && (yield Promise.all(t.map((t => r(this, void 0, void 0, (function*() {
                    ...
                    static event(t) {
                        var e, n, i, o, a, l, c, d, u, v, p, h, g, f, y, m, b, T, w, k, C, _, L;
                        return r(this, void 0, void 0, (function*() {
                            ...
                            if (console.log(`response for ${null===(e=t.lead)||void 0===e?void 0:e.pixelId}: ${null===(n=null==x?void 0:x.lead)||void 0===n?void 0:n.metaPixelIds}`), null == x.lead._id) return null;
                            const I = new s.Lead({
                                _id: x.lead._id,
                                pixelId: x.lead.pixelId,
                                userAgent: null !== (o = null === (i = null == t ? void 0 : t.lead) || void 0 === i ? void 0 : i.userAgent) && void 0 !== o ? o : "",
                                birthdate: x.lead.birthdate,
                                email: x.lead.email,
                                fbc: x.lead.fbc,
                                fbp: null === (a = null == t ? void 0 : t.lead) || void 0 === a ? void 0 : a.fbp,
                                gclid: null !== (p = null !== (c = null === (l = null == x ? void 0 : x.lead) || void 0 === l ? void 0 : l.gclid) && void 0 !== c ? c : null === (v = null === (u = null === (d = null == x ? void 0 : x.event) || void 0 === d ? void 0 : d.log) || void 0 === u ? void 0 : u.leadData) || void 0 === v ? void 0 : v.gclid) && void 0 !== p ? p : null === (h = null == t ? void 0 : t.lead) || void 0 === h ? void 0 : h.gclid,
                                firstName: x.lead.firstName,
                                geolocation: x.lead.geolocation,
                                ip: x.lead.ip,
                                ipv6: x.lead.ipv6,
                                lastName: x.lead.lastName,
                                metaPixelIds: x.lead.metaPixelIds,
                                phone: x.lead.phone,
                                parameters: x.lead.parameters,
                                updatedAt: new Date,
                                icTextMatch: null !== (g = x.icTextMatch) && void 0 !== g ? g : null,
                                icCSSMatch: null !== (f = x.icCSSMatch) && void 0 !== f ? f : null,
                                ipConfiguration: x.ipConfiguration,
                                leadTextMatch: null !== (y = x.leadTextMatch) && void 0 !== y ? y : null,
                                icURLMatch: null !== (m = x.icURLMatch) && void 0 !== m ? m : null,
                                addToCartTextMatch: null !== (b = x.addToCartTextMatch) && void 0 !== b ? b : null
                            });
                            return "PageView" === t.type && (yield this.init(I.metaPixelIds)), (null !== (w = null === (T = I.metaPixelIds) || void 0 === T ? void 0 : T.length) && void 0 !== w ? w : 0) > 0 && this.metaEvent(Object.assign(Object.assign({}, t), {
                                event: {
                                    _id: x.event._id,
                                    pageTitle: null !== (C = null === (k = t.event) || void 0 === k ? void 0 : k.pageTitle) && void 0 !== C ? C : null,
                                    sourceUrl: null !== (L = null === (_ = t.event) || void 0 === _ ? void 0 : _.sourceUrl) && void 0 !== L ? L : null
                                }
                            })), I
                        }))
                    }
                    ...
                    static getClientIpAddress(t, e, n) {
                        return r(this, void 0, void 0, (function*() {
                            switch (n) {
                                case l.IpConfigurationType.IPV6_ONLY:
                                    return t;
                                case l.IpConfigurationType.IPV6_OR_IPV4:
                                    return t || e;
                                case l.IpConfigurationType.NO_IP:
                                    return;
                                default:
                                    return t || e
                            }
                    ...
                    static metaEvent(t) {
                        var e, n, i, o, a, l, s, u, v, p, h, g, f, y, m, b, T, w, k, C, _, L, x, I;
                        return r(this, void 0, void 0, (function*() {
                            const r = c.StringUtils.removeAllNonAlphaChars(null !== (i = null === (n = null === (e = t.lead) || void 0 === e ? void 0 : e.geolocation) || void 0 === n ? void 0 : n.city) && void 0 !== i ? i : void 0),
                                F = c.StringUtils.removeAllNonAlphaChars(null !== (l = null === (a = null === (o = t.lead) || void 0 === o ? void 0 : o.geolocation) || void 0 === a ? void 0 : a.state) && void 0 !== l ? l : void 0),
            ...
            526: function(t, e, n) {
                ...
                class g {
                    ...
                    static init(t) {
                        return r(this, void 0, void 0, (function*() {
                            ...
                            g.ipv4 = e, g.ipv6 = n, d.FormsListener.init(), v.NavigationListener.init(), g.track("PageView"), h.ViewContentListener.init(), yield g.trySendFbp()
                        }))
                    }
                    static trySendFbp() {
                        return r(this, void 0, void 0, (function*() {
                ...
                g.inited = !1, g.type = "Meta", g.trackedEvents = [], i([a.visibleForTesting, o("design:type", String), o("design:paramtypes", [])], g, "pixelId", null), i([a.visibleForTesting, o("design:type", Function), o("design:paramtypes", []), o("design:returntype", l.Lead)], g, "getLeadFromLocalStorageOrNew", null), i([a.visibleForTesting, o("design:type", Function), o("design:paramtypes", [l.Lead]), o("design:returntype", l.Lead)], g, "getLeadWithBasicFields", null), i([a.visibleForTesting, o("design:type", Function), o("design:paramtypes", [l.Lead]), o("design:returntype", Object)], g, "getFbc", null), i([a.visibleForTesting, o("design:type", Function), o("design:paramtypes", [l.Lead]), o("design:returntype", Object)], g, "getFbp", null), i([a.visibleForTesting, o("design:type", Function), o("design:paramtypes", [l.Lead]), o("design:returntype", Object)], g, "getGclid", null), i([a.visibleForTesting, o("design:type", Function), o("design:paramtypes", []), o("design:returntype", Object)], g, "getEventData", null), e.Tracker = g
            },
            923: function(t, e) {
                var n = this && this.__awaiter || function(t, e, n, i) {
                    return new(n || (n = Promise))((function(o, r) {
            ...
            436: function(t, e, n) {
                ...
                class c {
                    ...
                    static trackByTime() {
                        return r(this, void 0, void 0, (function*() {
                            yield s.Utils.wait(8e3), l.Tracker.track("ViewContent")
                        }))
                    }
                    static trackByScroll() {
                        return r(this, void 0, void 0, (function*() {
                            window.addEventListener("scroll", (() => r(this, void 0, void 0, (function*() {
                                console.log("scrolling", window.scrollY), window.scrollY > 100 && l.Tracker.track("ViewContent")
                            }))))
                        }))
                    }
                }
