...
function WAU_small(e, t) {
    if (typeof t === "undefined") {
        ...
        try {
            if (typeof Storage === "undefined" || localStorage.getItem("_waucount:" + e) === null || localStorage.getItem("_wautime:" + e) === null || localStorage.getItem("_waulasturl:" + e) != n || Math.floor(Date.now() / 1e3) - localStorage.getItem("_wautime:" + e) > 150) {
                WAU_small_request(e, t)
            } else {
                WAU_r_s(localStorage.getItem("_waucount:" + e) * (Math.floor(Math.random() * (102 - 98 + 1) + 98) / 100), e, t, true)
            }
            localStorage.setItem("_waulasturl:" + e, n)
        } catch (n) {
            WAU_small_request(e, t)
        }
    }
...
function WAU_small_request(e, t) {
    var n = "";
    if (document.title) {
        n = encodeURIComponent(document.title.substr(0, 80).replace(/(\?=)|(\/)/g, ""))
    }
    ...
    (function() {
        ...
        s.src = "//whos.amung.us/pingjs/?k=" + e + "&t=" + n + "&c=s&x=" + r + "&y=" + i + "&a=" + t + "&d=" + o + "&v=27&r=" + Math.ceil(Math.random() * 9999);
...
function WAU_r_s(c, key, async_index, skip_storage) {
    ...
    img.onload = function() {
        ...
        for (var n = 0; n < c.length; n++) {
            ...
            o.style.backgroundImage = "url(" + raw_im_data + ")";
            o.style.backgroundRepeat = "no-repeat";
            o.style.backgroundAttachment = "scroll";
            o.style.backgroundPosition = a[0] + "px " + a[1] + "px";
            o.style.position = "absolute";
            o.style.width = a[2] + "px";
            o.style.height = a[3] + "px";
            o.style.top = "4px";
            o.style.left = t + "px";
            o.style.lineHeight = a[3] + "px";
        ...
        if (async_index >= 0) {
            var i = document.getElementById("_wau" + _wau[async_index][2]);
            i.parentNode.insertBefore(e, i.nextSibling)
        } else {
            WAU_insert(e, "amung.us/small.js")
        }
    };
    img.src = raw_im_data;
...
function WAU_insert(e, t) {
    ...
    for (var a = 0; a < n.length; a++) {
        if (n[a].src.indexOf(t) > 0) {
            n[a].parentNode.insertBefore(e, n[a].nextSibling)
        }
    }
}
    ...
    for (var e = 0; e < _wau.length; e++) {
        if (typeof WAU_ren[e] === "undefined" || WAU_ren[e] == false) {
            if (typeof window["WAU_" + _wau[e][0]] === "function") {
                WAU_ren[e] = true;
                if (_wau[e][0] == "map") window["WAU_map"](_wau[e][1], _wau[e][3], _wau[e][4], _wau[e][5], _wau[e][6], e);
                else if (_wau[e][0] == "dynamic") window["WAU_dynamic"](_wau[e][1], _wau[e][3], _wau[e][4], e);
                else if (typeof _wau[e][3] !== "undefined") window["WAU_" + _wau[e][0]](_wau[e][1], _wau[e][3], e);
                else window["WAU_" + _wau[e][0]](_wau[e][1], e)
            } else {
...
function WAU_lrd() {
    ...
    var n = e._isDstObserved();
    if (typeof Intl === "undefined" || typeof Intl.DateTimeFormat === "undefined") {
        if (n && t >= -120 && t <= -60 || !n && t >= -60 && t <= 0) {
            return false
        }
    } else {
        var a = Intl.DateTimeFormat();
        var o = a.resolvedOptions().timeZone;
        var i = o.toLowerCase().split("/");
        if (i[0] == "europe" && (n && t >= -120 && t <= -60 || !n && t >= -60 && t <= 0)) {
            return false
        }
    }
    return true
